  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="description"
          content="COSH! is your destination for sustainable and ethical fashion. Discover eco-friendly retailers, learn about sustainability practices, and join a community making a positive impact."
        />
        <meta property="og:title" content="COSH! | Sustainable Fashion Discovery" />
        <meta
          property="og:description"
          content="Connect with eco-friendly retailers and discover sustainable fashion on COSH!"
        />
        <meta property="og:type" content="website" />
      </Head>
      <div className="flex-1 bg-[#060026]">
        <div className={'flex min-w-[100%] flex-col items-center pt-7'}>
          <h1 className="inter-medium text-4xl text-[#FBF6F0]">Welcome to COSH!</h1>
          <p className="source-serif-pro-normal col mt-4 mb-3 max-w-2xl text-[#FBF6F0]">
          ...
          <p className="source-serif-pro-normal mb-3 max-w-2xl text-[#FBF6F0]">
          ...
          <p className="source-serif-pro-normal mb-6 max-w-2xl text-[#FBF6F0]">
