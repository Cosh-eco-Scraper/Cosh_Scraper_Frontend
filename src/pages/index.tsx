...
export default function Home() {
  ...
  return (
    <>
      <Head>
        <title>Welcome to COSH! | Sustainable & Ethical Fashion Platform</title>
        <meta
          name="description"
          content="COSH! connects conscious consumers and retailers for sustainable, ethical fashion. Register your store or discover eco-friendly brands and shops."
        />
        <meta property="og:title" content="Welcome to COSH!" />
        <meta
            ...
            <div className="flex w-full flex-row items-center justify-center">
              ...
              <div className="flex flex-1 flex-col items-center justify-center">
                ...
                <p className="mt-4 mb-3 max-w-2xl text-lg text-[#FBF6F0]">
                  COSH! is your ultimate destination for sustainable and ethical fashion discovery.
                  We connect conscious consumers with eco-friendly retailers, making sustainable
                  shopping easier than ever before.
                </p>
                <p className="mb-6 max-w-2xl text-lg text-[#FBF6F0]">
                  Join our growing community of responsible retailers and conscious consumers who
                  are making a positive impact on the fashion industry, one purchase at a time.
                </p>
