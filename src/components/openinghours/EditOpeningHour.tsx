...
export function EditOpeningHour({
  ...
  const initialIsBreakTimeState =
    !!openingAtAfterNoon &&
    openingAtAfterNoon !== 'Closed' &&
    !!closingAtAfterNoon &&
    closingAtAfterNoon !== 'Closed';
  ...
  useEffect(() => {
    ...
    setFormValues(currentFormValues => {
      ...
      if (newIsClosed) {
        ...
        if (
          currentFormValues.openingAt !== '' ||
          currentFormValues.closingAt !== '' ||
          currentFormValues.openingAtAfterNoon !== '' ||
          currentFormValues.closingAtAfterNoon !== ''
        ) {
        ...
        if (
          currentFormValues.openingAt !== transformedOpening ||
  ...
  const handleBreakTimeToggle = useCallback(() => {
    ...
    if (!newBreakTimeState) {
      // If turning break time OFF
      setFormValues(prev => ({
        ...prev,
        openingAtAfterNoon: '',
        closingAtAfterNoon: '',
      ...
      {!readOnly && (
        <td className="px-4 py-2 text-center">
          <input
            ...
            className="form-checkbox h-5 w-5 cursor-pointer rounded-md text-indigo-600 focus:ring-indigo-500"
      ...
      {!readOnly && (
        <td className="px-4 py-2 text-center">
          <input
            ...
            className="form-checkbox h-5 w-5 cursor-pointer rounded-md text-red-600 focus:ring-red-500"
            disabled={readOnly}
          />
        </td>
      )}
