    ...
    return (
        <div className="bg-white p-6 rounded-2xl shadow-md">
            ...
            <table className="min-w-full divide-y divide-gray-200">
                ...
                <tr>
                    <th className="px-4 py-2 text-center text-xs font-medium text-gray-500 uppercase tracking-wider">Break</th>
                    <th className="px-4 py-2 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">Day</th>
                    <th className="px-4 py-2 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">Morning Open</th>
                    <th className="px-4 py-2 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">Morning Close</th>
                    <th className="px-4 py-2 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">Afternoon Open</th>
                    <th className="px-4 py-2 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">Afternoon Close</th>
                    <th className="px-4 py-2 text-center text-xs font-medium text-gray-500 uppercase tracking-wider">Closed</th>
                </tr>
                </thead>
                ...
                {openingHours.map((hour) => (
                    <EditOpeningHour
                        ...
                        onChange={useCallback(( // <-- WRAP IN USECALLBACK
                            id: any, // <-- RECEIVE ID
                            day: any, // <-- RECEIVE DAY
                            openingAt: any,
                            closingAt: any,
                            ...
                            updateHour({ // Call the parent's updateHour
